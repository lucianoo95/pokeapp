...
const src = 'https://www.iconninja.com/files/616/192/971/play-pokemon-pokeball-go-game-icon.png'
    ...
    >
      {side ? (
        <Card>
          ...
          <Title className='anime-title' mgTop='25px'>
            Lapras
          </Title>
          <GenericContainer>
            {abilities.map((e, i) => {
              return (
                <Ability className='anime-title' key={`ability_${i}`}>
                  {e.name}
                </Ability>
              )
            })}
          ...
          <GenericContainer>
            ...
            <TransparentButton className='anime-button' onClick={changeSide}>
              stats
            </TransparentButton>
          </GenericContainer>
        </Card>
